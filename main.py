...
from agenda_gui import main as gui_main
...
class AppAgenda:
    ...
    def criar_formulario(self):
        ...
        ttk.Button(botoes, text="Remover", command=self.remover).pack(
            side="left", padx=6
        )
        ttk.Button(
    ...
    def validar_campos(self):
        ...
        try:
            ...
            messagebox.showwarning(
                "Validacao",
                "Data invalida. Use o formato AAAA-MM-DD, por exemplo: 2026-05-01.",
            )
            return None
    ...
    def carregar_compromissos(self):
        ...
        compromissos = func.listar_compromissos()
    ...
    def adicionar(self):
        ...
        func.adicionar_compromisso(nome, descricao, data_limite)
        self.carregar_compromissos()
    ...
    def atualizar(self):
        ...
        nome, descricao, data_limite = dados
        func.atualizar_compromisso(self.item_selecionado_id, nome, descricao, data_limite)
        self.carregar_compromissos()
        self.limpar_formulario()
    ...
    def remover(self):
        ...
        confirmar = messagebox.askyesno(
            "Confirmacao", "Deseja realmente remover o compromisso selecionado?"
        )
        if not confirmar:
            return

        func.remover_compromisso(self.item_selecionado_id)
        self.carregar_compromissos()
        self.limpar_formulario()
...
def ler_data(mensagem):
    while True:
        ...
        try:
            ...
            print("Data inválida. Use o formato AAAA-MM-DD (ex: 2026-04-30).")
...
while True:
    ...
    print("4. Atualizar Compromisso")
    print("5. Sair")
    opcao = ler_inteiro("Digite a opção desejada: ", minimo=1, maximo=5)

    if opcao == 1:
        nome = input("Digite o nome do compromisso: ")
        descricao = input("Digite a descrição do compromisso: ")
        data_limite = ler_data("Digite a data limite do compromisso (AAAA-MM-DD): ")
        func.adicionar_compromisso(nome, descricao, data_limite)
    elif opcao == 2:
        id = ler_inteiro("Digite o ID do compromisso: ", minimo=1)
        func.remover_compromisso(id)
    elif opcao == 3:
        func.listar_compromissos()
    elif opcao == 4:
        id = ler_inteiro("Digite o ID do compromisso: ", minimo=1)
        nome = input("Digite o nome do compromisso: ")
        descricao = input("Digite a descrição do compromisso: ")
        data_limite = ler_data("Digite a data limite do compromisso (AAAA-MM-DD): ")
        func.atualizar_compromisso(id, nome, descricao, data_limite)
    elif opcao == 5:
        break
